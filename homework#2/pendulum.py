...
def render (pos_xy) :
  screen.fill(white)
  pygame.draw.line(screen, black, (x_center, y_center), (pos_xy[0]*1.3, pos_xy[1]*1.3), 2)
  pygame.draw.circle(screen, green, (pos_xy[0], pos_xy[1]), 10)
  pygame.draw.circle(screen, green, (pos_xy[0]*1.3, pos_xy[1]*1.3), 10)

def G (t,y) :
  F[0] = -g*sin(y[1]) + 0.5*sin(y[1])
  F[1] = y[0]
  return inv_L.dot(F)
